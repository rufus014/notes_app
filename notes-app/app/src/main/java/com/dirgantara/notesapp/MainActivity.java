...
public class MainActivity extends AppCompatActivity
{
    ...
    @Override
    protected void onCreate(Bundle savedInstanceState) //отрисовка списка заметок
    {
    ...
    private void loadFromDBToMemory() //подгрузка заметок из памяти
    {
    ...
    public void newNote(View view) //новая заметка
    {
